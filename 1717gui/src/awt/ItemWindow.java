	...
	public ItemWindow() {
		...
		ActionListener action1 = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String caText = category[caNum];
				String coText = content[caNum][coNum];
				ta.setText(caText + " : " + coText);
